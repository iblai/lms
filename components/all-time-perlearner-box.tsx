...
export const AllTimePerLearnerBox = ({total_assessments, total_time_spent, total_videos, course_completions}: AllTimePerLearnerBoxProps) => {
    const hours = typeof total_time_spent === 'number' && !isNaN(total_time_spent) 
        ? Math.round(total_time_spent / 3600)
        : 0;
    
    return (
        <div className="mb-4 rounded-md border border-[var(--sidebar-border)] p-4">
            <h3 className="mb-3 text-sm md:text-base font-medium text-[var(--sidebar-text)]">All Time</h3>
