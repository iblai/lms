 ...
 * When RBAC is fully implemented, update to use useAppSelector with rbacPermissions from Redux store
...
export const checkRbacPermission = (rbacPermissions: object, rbacResource: string): boolean => {
  return baseCheckRbacPermission(rbacPermissions, rbacResource, config.settings.enableRBAC());
};
