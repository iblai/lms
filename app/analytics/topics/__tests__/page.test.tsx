...
vi.mock('@iblai/iblai-js/web-containers', () => ({
  AnalyticsTopicsStats: vi.fn(({ tenantKey, mentorId, usergroupIds }) => (
    <div data-testid="analytics-topics-stats">
...
describe('TopicsPage', () => {
  ...
  it('renders the AnalyticsTopicsStats component', () => {
    render(<TopicsPage />);
    expect(screen.getByTestId('analytics-topics-stats')).toBeInTheDocument();
  });
