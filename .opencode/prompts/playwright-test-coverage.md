...
<generate>
  <test-suite><!-- Verbatim name of the test spec group w/o ordinal like "Course Discovery tests" --></test-suite>
  <test-name><!-- Name of the test case without the ordinal like "should search for course" --></test-name>
  <test-file><!-- Name of the file to save the test into, like tests/discovery/should-search-for-course.spec.ts --></test-file>
